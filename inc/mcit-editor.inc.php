...
class MCIT_editor {
    ...
    public function __construct() {
        ...
        $this->server_info_fields = [
            ...
            ['slug' => 'discordUser', 'name' => __('Utente Discord', 'mcit'), 'desc' => __('L\'ID sistema del tuo utente Discord. Lo puoi ottenere andando in "Il mio account", cliccando sul menu in alto a destra, "Copia l\'ID".<br>Se non si vede questa opzione, è possibile abilitarla in fondo alla sezione "Aspetto" delle impostazioni di Discord ("Modalità per sviluppatori")', 'mcit'), 'type' => 'text', 'length' => '36'],
